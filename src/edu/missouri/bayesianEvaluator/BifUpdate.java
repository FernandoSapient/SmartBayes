 ...
 * 
 * @author <a href="mailto:fthc8@missouri.edu">Fernando J. Torre-Mora</a>
 * @version {@link bayesianEvaluator} version 0.03 2016-04-19
 * @since {@link bayesianEvaluator} version 0.01 2016-04-01
 */
public class BifUpdate {

	/**
	 * Loads a Bayesian network from an XML BIF file into a weka
	 * {@code BayesNet}
	 * 
	 * @param filename
	 ...
	 */
	public static EditableBayesNet loadBayesNet(String filename)
			throws Exception {
	...
	/**
	 * Converts the given bif file into the Weka format by loading it into Weka
	 * and then writing it back into a file. The program may print warnings and
	 * non-fatal errors if the input file is not already in Weka format.
	 * 
	 * 
	 * @param args
	 *            an array containing the input ({@code args[0]}) and output (
	 *            {@code args[1]}) filenames
	 * @throws Exception
	...
	public static void main(String[] args) throws Exception {
		if (args.length < 1) {
			System.err
					.println("Usage: java BifUpdate <input filename> <output filename>");
			return;
		}
